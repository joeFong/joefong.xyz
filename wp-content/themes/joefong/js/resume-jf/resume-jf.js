...
class ResumeJF extends LitElement {
  ...
  constructor() {
    ...
    this.resume = {
      ...
      socialMedia: [
        "https://linkedin.com/in/loremipson",
        "https://github.com/loremipson",
        "https://medium.com/@loremipson",
        "https://joefong.xyz"
      ],
      professionalSummary: [
        {
      ...
      experience: [
        ...
        },
        {
          ...
          duration: 'April 2017 - Present (Same organization as Lorem Ipsum)',
        ...
        {
          jobTitle: 'Lorem Ipsum (Internship Experience)',
          role: 'Full-Stack Developer',
      ...
      education: [
        {
          ...
          yearCompleted: '2017',
          educationCompleted: 'Associates Degree, Graduated With Distinctions'
        }
      ]
    }
  }
