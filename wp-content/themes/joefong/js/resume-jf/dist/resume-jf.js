 ...
 * subject to an additional IP rights grant found at
 * http://polymer.github.io/PATENTS.txt
 */const R=new class{handleAttributeExpressions(e,t,s,n){const i=t[0];if("."===i){return new C(e,t.slice(1),s).parts}return"@"===i?[new E(e,t.slice(1),n.eventContext)]:"?"===i?[new N(e,t.slice(1),s)]:new x(e,t,s).parts}handleTextExpression(e){return new k(e)}};
/**
 * @license
 * Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
 * This code may only be used under the BSD style license found at
